...
function Project() {
	return (
		<div className="m-4">
			...
			{projects.map(
				({ name, codebase, live, description }, index) => (
					<Card
						key={index}
						className="rounded-md bg-zinc-900 border-2 border-zinc-800 mt-4 text-col-yel p-4"
					>
						<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
							...
							<div className="mt-4 sm:mt-0 flex flex-col sm:items-end text-sm space-y-1">
								{codebase ? (
									<a
										href={codebase}
